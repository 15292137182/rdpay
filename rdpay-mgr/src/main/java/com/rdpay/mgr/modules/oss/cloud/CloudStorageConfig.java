package com.rdpay.mgr.modules.oss.cloud;


import com.rdpay.mgr.common.validator.group.AliyunGroup;
import com.rdpay.mgr.common.validator.group.FastDFSGroup;
import com.rdpay.mgr.common.validator.group.QcloudGroup;
import com.rdpay.mgr.common.validator.group.QiniuGroup;
...
public class CloudStorageConfig implements Serializable {
    ...
    //fastDFS
    @NotBlank(message = "fastDFS key 不能为空", groups = FastDFSGroup.class)
    private String fastDFSSecretKey;

    @NotBlank(message = "fastDFS ng 端口不能为空", groups = FastDFSGroup.class)
    private String fastDFSPort;

    @NotBlank(message = "fastDFS 服务器地址不能为空", groups = FastDFSGroup.class)
    ...
    public void setFastDFSSecretKey(String fastDFSSecretKey) {
        this.fastDFSSecretKey = fastDFSSecretKey;
    }

    public String getFastDFSPort() {
        return fastDFSPort;
    }

    public void setFastDFSPort(String fastDFSPort) {
        this.fastDFSPort = fastDFSPort;
    }
